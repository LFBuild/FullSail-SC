module clmm_pool::partner {
    struct Partners has key {
        id: 0x2::object::UID,
        partners: 0x2::vec_map::VecMap<std::string::String, 0x2::object::ID>,
    }
    ...
    public fun claim_ref_fee<T0>(arg0: &clmm_pool::config::GlobalConfig, arg1: &PartnerCap, arg2: &mut Partner, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::bag::contains<std::string::String>(&arg2.balances, v0), 4);
        let v1 = 0x2::bag::remove<std::string::String, 0x2::balance::Balance<T0>>(&mut arg2.balances, v0);
    ...
    public fun create_partner(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Partners, arg2: std::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > arg4, 6);
        assert!(arg4 >= 0x2::clock::timestamp_ms(arg7) / 1000, 7);
        assert!(arg3 < 10000, 2);
        assert!(!std::string::is_empty(&arg2), 5);
        assert!(!0x2::vec_map::contains<std::string::String, 0x2::object::ID>(&arg1.partners, &arg2), 5);
        clmm_pool::config::checked_package_version(arg0);
        ...
        0x2::vec_map::insert<std::string::String, 0x2::object::ID>(&mut arg1.partners, arg2, v1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Partners{
            ...
            partners : 0x2::vec_map::empty<std::string::String, 0x2::object::ID>(),
        };
    ...
    public fun receive_ref_fee<T0>(arg0: &mut Partner, arg1: 0x2::balance::Balance<T0>) {
        let v0 = std::string::from_ascii(std::type_name::into_string(std::type_name::get<T0>()));
        if (0x2::bag::contains<std::string::String>(&arg0.balances, v0)) {
            0x2::balance::join<T0>(0x2::bag::borrow_mut<std::string::String, 0x2::balance::Balance<T0>>(&mut arg0.balances, v0), arg1);
        } else {
            0x2::bag::add<std::string::String, 0x2::balance::Balance<T0>>(&mut arg0.balances, v0, arg1);
        };
