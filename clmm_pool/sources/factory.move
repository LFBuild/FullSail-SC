module clmm_pool::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &mut Pools, arg1: &clmm_pool::config::GlobalConfig, arg2: u32, arg3: u128, arg4: std::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_pool_<T0, T1>(arg0: &mut Pools, arg1: &clmm_pool::config::GlobalConfig, arg2: u32, arg3: u128, arg4: std::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : clmm_pool::pool::Pool<T0, T1> {
        clmm_pool::config::checked_package_version(arg1);
        create_pool_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6)
    }
    
    fun create_pool_internal<T0, T1>(arg0: &mut Pools, arg1: &clmm_pool::config::GlobalConfig, arg2: u32, arg3: u128, arg4: std::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : clmm_pool::pool::Pool<T0, T1> {
    ...
    public fun create_pool_with_liquidity<T0, T1>(arg0: &mut Pools, arg1: &clmm_pool::config::GlobalConfig, arg2: u32, arg3: u128, arg4: std::string::String, arg5: u32, arg6: u32, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (clmm_pool::position::Position, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        clmm_pool::config::checked_package_version(arg1);
    ...
    public fun fetch_pools(arg0: &Pools, arg1: vector<0x2::object::ID>, arg2: u64) : vector<PoolSimpleInfo> {
        ...
        let v1 = if (std::vector::is_empty<0x2::object::ID>(&arg1)) {
            ...
            move_stl::linked_table::next<0x2::object::ID, PoolSimpleInfo>(move_stl::linked_table::borrow_node<0x2::object::ID, PoolSimpleInfo>(&arg0.list, *std::vector::borrow<0x2::object::ID>(&arg1, 0)))
        };
        let v2 = v1;
        let v3 = 0;
        while (std::option::is_some<0x2::object::ID>(&v2) && v3 < arg2) {
            let v4 = move_stl::linked_table::borrow_node<0x2::object::ID, PoolSimpleInfo>(&arg0.list, *std::option::borrow<0x2::object::ID>(&v2));
            v2 = move_stl::linked_table::next<0x2::object::ID, PoolSimpleInfo>(v4);
            std::vector::push_back<PoolSimpleInfo>(&mut v0, *move_stl::linked_table::borrow_value<0x2::object::ID, PoolSimpleInfo>(v4));
            v3 = v3 + 1;
        };
        v0
    }
    ...
    public fun new_pool_key<T0, T1>(arg0: u32) : 0x2::object::ID {
        ...
        std::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<u32>(&arg0));
