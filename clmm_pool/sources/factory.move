module clmm_pool::factory {
    ...
    fun create_pool_internal<T0, T1>(
        ...
        let v4 = clmm_pool::pool::new<T0, T1>(
            arg2,
            arg3,
            clmm_pool::config::get_fee_rate(arg2, arg1),
            v3,
            arg0.index,
            arg5,
            arg6
    ...
    public fun create_pool_with_liquidity<T0, T1>(
        arg0: &mut Pools,
        arg1: &clmm_pool::config::GlobalConfig,
        arg2: u32,
        arg3: u128,
        ...
        arg5: u32,
        arg6: u32,
        mut arg7: sui::coin::Coin<T0>,
        mut arg8: sui::coin::Coin<T1>,
        arg9: u64,
        arg10: u64,
        arg11: bool,
        arg12: &sui::clock::Clock,
        arg13: &mut sui::tx_context::TxContext
    ): (clmm_pool::position::Position, sui::coin::Coin<T0>, sui::coin::Coin<T1>) {
        clmm_pool::config::checked_package_version(arg1);
        ...
        clmm_pool::pool::repay_add_liquidity<T0, T1>(
            arg1,
            &mut v0,
            sui::coin::into_balance<T0>(sui::coin::split<T0>(&mut arg7, v4, arg13)),
            sui::coin::into_balance<T1>(sui::coin::split<T1>(&mut arg8, v5, arg13)),
            v3
        );
    ...
    public fun fetch_pools(arg0: &Pools, arg1: vector<sui::object::ID>, arg2: u64): vector<PoolSimpleInfo> {
        ...
        let v1 = if (std::vector::is_empty<sui::object::ID>(&arg1)) {
            ...
            move_stl::linked_table::next<sui::object::ID, PoolSimpleInfo>(
                move_stl::linked_table::borrow_node<sui::object::ID, PoolSimpleInfo>(
                    &arg0.list,
                    *std::vector::borrow<sui::object::ID>(&arg1, 0)
                )
            )
        };
        let mut v2 = v1;
        ...
        while (std::option::is_some<sui::object::ID>(&v2) && v3 < arg2) {
            let v4 = move_stl::linked_table::borrow_node<sui::object::ID, PoolSimpleInfo>(
                &arg0.list,
                *std::option::borrow<sui::object::ID>(&v2)
            );
            v2 = move_stl::linked_table::next<sui::object::ID, PoolSimpleInfo>(v4);
            std::vector::push_back<PoolSimpleInfo>(
                &mut v0,
                *move_stl::linked_table::borrow_value<sui::object::ID, PoolSimpleInfo>(v4)
            );
            v3 = v3 + 1;
        };
        v0
