module clmm_pool::clmm_math {
    public fun compute_swap_step(arg0: u128, arg1: u128, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: bool) : (u64, u64, u128, u64) {
        ...
        let (v0, v1, v2, v3) = if (arg6) {
            let v4 = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u64::mul_div_floor(arg3, 1000000 - arg4, 1000000);
            let v5 = v4;
            if (arg4 > 0 && v4 == arg3) {
                v5 = v4 - 1;
            };
            ...
            let (v7, v8, v9) = if (v6 > (v5 as u256)) {
                ...
                (v6 as u64, 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u64::mul_div_ceil(v6 as u64, arg4, 1000000 - arg4), arg1)
            };
            ...
            let v14 = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u64::mul_div_ceil(v13, arg4, 1000000 - arg4);
            let v15 = v14;
            if (arg4 > 0 && v14 == 0) {
                v15 = 1;
            };
    ...
    public fun get_delta_a(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u64 {
        ...
        let (v1, v2) = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::checked_shlw(0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg2, v0));
        if (v2) {
            abort 2
        };
        0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::div_round(v1, 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg0, arg1), arg3) as u64
    }
    ...
    public fun get_delta_b(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u64 {
        ...
        let v1 = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg2, v0);
    ...
    public fun get_delta_down_from_output(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u256 {
        ...
        if (arg3) {
            0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg2, v0) >> 64
        } else {
            let (v2, v3) = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::checked_shlw(0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg2, v0));
            if (v3) {
                abort 2
            };
            0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::div_round(v2, 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg0, arg1), false)
        }
    }
    ...
    public fun get_delta_up_from_input(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u256 {
        ...
        if (arg3) {
            ...
            0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::div_round(v2, 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg0, arg1), true)
        } else {
            let v4 = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg2, v0);
            let v5 = if (v4 & 18446744073709551615 > 0) {
                (v4 >> 64) + 1
            } else {
                v4 >> 64
            };
    ...
    public fun get_liquidity_from_a(arg0: u128, arg1: u128, arg2: u64, arg3: bool) : u128 {
        ...
        0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::div_round((0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg0, arg1) >> 64) * (arg2 as u256), v0 as u256, arg3) as u128
    }
    ...
    public fun get_liquidity_from_b(arg0: u128, arg1: u128, arg2: u64, arg3: bool) : u128 {
        ...
        0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::div_round((arg2 as u256) << 64, v0 as u256, arg3) as u128
    }
    ...
    public fun get_next_sqrt_price_a_up(arg0: u128, arg1: u128, arg2: u64, arg3: bool) : u128 {
        ...
        let (v0, v1) = 0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::math_u256::checked_shlw(0x1610277a9d5080de4673f4d1b3f4da1b7ab76cf89d9919f5607ea195b9f5da7f::full_math_u128::full_mul(arg0, arg1));
        if (v1) {
            abort 2
        };
        let v2 = if (arg3) {
