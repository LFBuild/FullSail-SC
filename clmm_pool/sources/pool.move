module clmm_pool::pool {
    ...
    public fun borrow_position_info<T0, T1>(
        arg0: &Pool<T0, T1>,
        arg1: sui::object::ID
    ...
    public fun close_position<T0, T1>(
    ...
    public fun mark_position_staked<T0, T1>(
        arg0: &mut Pool<T0, T1>,
    ...
    public fun open_position<T0, T1>(
        ...
        let v3 = clmm_pool::position::open_position<T0, T1>(
    ...
    public fun update_emission<T0, T1, T2>(
        arg0: &clmm_pool::config::GlobalConfig,
        arg1: &mut Pool<T0, T1>,
        ...
        clmm_pool::rewarder::update_emission<T2>(
            arg2,
            &mut arg1.rewarder_manager,
            arg1.liquidity,
            arg3,
