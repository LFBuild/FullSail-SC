module clmm_pool::pool {
    ...
    public(friend) fun new<T0, T1>(arg0: u32, arg1: u128, arg2: u64, arg3: std::string::String, arg4: u64, arg5: &sui::clock::Clock, arg6: &mut sui::tx_context::TxContext) : Pool<T0, T1> {
        let v0 = PoolFee{
            coin_a : 0, 
            coin_b : 0,
        };
    ...
    public fun calculate_and_update_fee<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::object::ID) : (u64, u64) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun calculate_and_update_magma_distribution<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::object::ID) : u64 {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        let v0 = clmm_pool::position::borrow_position_info(&arg1.position_manager, arg2);
        if (clmm_pool::position::info_liquidity(v0) != 0) {
    ...
    public fun calculate_and_update_points<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock) : u128 {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun calculate_and_update_reward<T0, T1, T2>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock) : u64 {
    ...
    public fun calculate_and_update_rewards<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock) : vector<u64> {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        clmm_pool::rewarder::settle(&mut arg1.rewarder_manager, arg1.liquidity, sui::clock::timestamp_ms(arg3) / 1000);
        let v0 = clmm_pool::position::borrow_position_info(&arg1.position_manager, arg2);
        ...
        while (v4 > 0) {
            ...
            if (v11 != 0 || v14 != 0) {
                ...
                if (v18 > 0) {
                    ...
                    let v22 = v18 - v21;
                    if (v22 > 0) {
                        let (_, v24) = calculate_fees<T0, T1>(arg1, v22, arg1.liquidity, arg1.magma_distribution_staked_liquidity, v7);
                        v19 = v24;
                    };
                };
    ...
    public fun collect_fee<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &clmm_pool::position::Position, arg3: bool) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun collect_magma_distribution_gauger_fees<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>) {
        assert!(!arg0.is_pause, 13);
        check_gauge_cap<T0, T1>(arg0, arg1);
        let v0 = sui::balance::zero<T0>();
        let v1 = sui::balance::zero<T1>();
        if (arg0.magma_distribution_gauger_fee.coin_a > 0) {
            sui::balance::join<T0>(&mut v0, sui::balance::split<T0>(&mut arg0.coin_a, arg0.magma_distribution_gauger_fee.coin_a));
            arg0.magma_distribution_gauger_fee.coin_a = 0;
        };
        if (arg0.magma_distribution_gauger_fee.coin_b > 0) {
            sui::balance::join<T1>(&mut v1, sui::balance::split<T1>(&mut arg0.coin_b, arg0.magma_distribution_gauger_fee.coin_b));
    ...
    public fun collect_protocol_fee<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut sui::tx_context::TxContext) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun collect_reward<T0, T1, T2>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &clmm_pool::position::Position, arg3: &mut clmm_pool::rewarder::RewarderGlobalVault, arg4: bool, arg5: &sui::clock::Clock) : sui::balance::Balance<T2> {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun flash_swap<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: bool, arg3: bool, arg4: u64, arg5: u128, arg6: &sui::clock::Clock) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>, FlashSwapReceipt<T0, T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        flash_swap_internal<T0, T1>(arg1, arg0, sui::object::id_from_address(@0x0), 0, arg2, arg3, arg4, arg5, arg6)
    }
    
    fun flash_swap_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &clmm_pool::config::GlobalConfig, arg2: sui::object::ID, arg3: u64, arg4: bool, arg5: bool, arg6: u64, arg7: u128, arg8: &sui::clock::Clock) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>, FlashSwapReceipt<T0, T1>) {
        assert!(arg6 > 0, 0);
    ...
    public fun flash_swap_with_partner<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &clmm_pool::partner::Partner, arg3: bool, arg4: bool, arg5: u64, arg6: u128, arg7: &sui::clock::Clock) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>, FlashSwapReceipt<T0, T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        flash_swap_internal<T0, T1>(arg1, arg0, sui::object::id<clmm_pool::partner::Partner>(arg2), clmm_pool::partner::current_ref_fee_rate(arg2, sui::clock::timestamp_ms(arg7) / 1000), arg3, arg4, arg5, arg6, arg7)
    }
    ...
    fun init(arg0: POOL, arg1: &mut sui::tx_context::TxContext) {
        sui::transfer::public_transfer<sui::package::Publisher>(sui::package::claim<POOL>(arg0, arg1), sui::tx_context::sender(arg1));
    }
    ...
    public fun init_magma_distribution_gauge<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap) {
        ...
        std::option::fill<sui::object::ID>(&mut arg0.magma_distribution_gauger_id, gauge_cap::gauge_cap::get_gauge_id(arg1));
    }
    
    public fun initialize_rewarder<T0, T1, T2>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut sui::tx_context::TxContext) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun mark_position_unstaked<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap, arg2: sui::object::ID) {
        assert!(!arg0.is_pause, 13);
        check_gauge_cap<T0, T1>(arg0, arg1);
        clmm_pool::position::mark_position_staked(&mut arg0.position_manager, arg2, false);
    }
    
    public fun pause<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut sui::tx_context::TxContext) {
        clmm_pool::config::checked_package_version(arg0);
    ...
    public fun remove_liquidity<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut clmm_pool::position::Position, arg3: u128, arg4: &sui::clock::Clock) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        assert!(arg3 > 0, 3);
    ...
    public fun repay_add_liquidity<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::balance::Balance<T0>, arg3: sui::balance::Balance<T1>, arg4: AddLiquidityReceipt<T0, T1>) {
        clmm_pool::config::checked_package_version(arg0);
    ...
    public fun repay_flash_swap<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: sui::balance::Balance<T0>, arg3: sui::balance::Balance<T1>, arg4: FlashSwapReceipt<T0, T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun repay_flash_swap_with_partner<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut clmm_pool::partner::Partner, arg3: sui::balance::Balance<T0>, arg4: sui::balance::Balance<T1>, arg5: FlashSwapReceipt<T0, T1>) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        let FlashSwapReceipt {
            pool_id             : v0,
    ...
    public fun set_display<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &sui::package::Publisher, arg2: std::string::String, arg3: std::string::String, arg4: std::string::String, arg5: std::string::String, arg6: std::string::String, arg7: std::string::String, arg8: &mut sui::tx_context::TxContext) {
        ...
        let v2 = sui::display::new_with_fields<Pool<T0, T1>>(arg1, v0, v1, arg8);
    ...
    public fun stake_in_magma_distribution<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap, arg2: u128, arg3: integer_mate::i32::I32, arg4: integer_mate::i32::I32, arg5: &sui::clock::Clock) {
        assert!(!arg0.is_pause, 13);
    ...
    fun swap_in_pool<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: bool, arg2: bool, arg3: u128, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &sui::clock::Clock) : SwapResult {
        ...
        while (v1 > 0 && arg0.current_sqrt_price != arg3) {
            ...
            if (v8 != 0 || v11 != 0) {
                ...
                if (v14 > 0) {
                    ...
                    v15 = v19;
                    if (v19 > 0) {
                        let (_, v21) = calculate_fees<T0, T1>(arg0, v19, arg0.liquidity, arg0.magma_distribution_staked_liquidity, arg5);
                        v16 = v21;
                        v15 = v19 - v21;
                    };
                };
    ...
    public fun sync_magma_distribution_reward<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap, arg2: u128, arg3: u64, arg4: u64) {
        assert!(!arg0.is_pause, 13);
        check_gauge_cap<T0, T1>(arg0, arg1);
    ...
    public fun unpause<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut sui::tx_context::TxContext) {
        clmm_pool::config::checked_package_version(arg0);
        clmm_pool::config::check_pool_manager_role(arg0, sui::tx_context::sender(arg2));
    ...
    public fun unstake_from_magma_distribution<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap, arg2: u128, arg3: integer_mate::i32::I32, arg4: integer_mate::i32::I32, arg5: &sui::clock::Clock) {
        assert!(!arg0.is_pause, 13);
    ...
    public fun update_fee_rate<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: u64, arg3: &mut sui::tx_context::TxContext) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
    ...
    public fun update_magma_distribution_growth_global<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &gauge_cap::gauge_cap::GaugeCap, arg2: &sui::clock::Clock) {
        assert!(!arg0.is_pause, 13);
        check_gauge_cap<T0, T1>(arg0, arg1);
        update_magma_distribution_growth_global_internal<T0, T1>(arg0, arg2);
    }
    
    fun update_magma_distribution_growth_global_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &sui::clock::Clock) : u64 {
    ...
    fun update_magma_distribution_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: integer_mate::i128::I128, arg2: integer_mate::i32::I32, arg3: integer_mate::i32::I32, arg4: &sui::clock::Clock) {
    ...
    public fun update_position_url<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: std::string::String, arg3: &mut sui::tx_context::TxContext) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
        clmm_pool::config::check_pool_manager_role(arg0, sui::tx_context::sender(arg3));
        arg1.url = arg2;
    ...
    public fun update_unstaked_liquidity_fee_rate<T0, T1>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: u64, arg3: &mut sui::tx_context::TxContext) {
        clmm_pool::config::checked_package_version(arg0);
        assert!(!arg1.is_pause, 13);
