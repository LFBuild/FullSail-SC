module distribution::fee_voting_reward {
    ...
    public fun deposit(arg0: &mut FeeVotingReward, arg1: &distribution::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: sui::object::ID, arg4: &sui::clock::Clock, arg5: &mut sui::tx_context::TxContext) {
    ...
    public fun get_prior_balance_index(arg0: &FeeVotingReward, arg1: sui::object::ID, arg2: u64) : u64 {
    ...
    public fun withdraw(arg0: &mut FeeVotingReward, arg1: &distribution::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: sui::object::ID, arg4: &sui::clock::Clock, arg5: &mut sui::tx_context::TxContext) {
    ...
    public fun notify_reward_amount<T0>(arg0: &mut FeeVotingReward, arg1: &distribution::reward_authorized_cap::RewardAuthorizedCap, arg2: sui::coin::Coin<T0>, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) {
