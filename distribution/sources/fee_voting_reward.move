...
module distribution::fee_voting_reward {
    ...
    public fun validate_voter_cap(reward: &FeeVotingReward, voter_cap: &distribution::voter_cap::VoterCap) {
    ...
    public fun borrow_reward(reward: &FeeVotingReward): &ve::reward::Reward {
        &reward.reward
    }
