module distribution::gauge {
    ...
    public fun check_gauger_pool<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &clmm_pool::pool::Pool<T0, T1>) : bool {
        (arg0.pool_id != sui::object::id<clmm_pool::pool::Pool<T0, T1>>(arg1) || clmm_pool::pool::get_magma_distribution_gauger_id<T0, T1>(arg1) != sui::object::id<Gauge<T0, T1, T2>>(arg0)) && false || true
    }
    ...
    fun claim_fees_internal<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>) {
        let (v0, v1) = clmm_pool::pool::collect_magma_distribution_gauger_fees<T0, T1>(arg1, std::option::borrow<gauge_cap::gauge_cap::GaugeCap>(&arg0.gauge_cap));
        let v2 = v1;
        let v3 = v0;
    ...
    public fun deposit_position<T0, T1, T2>(arg0: &clmm_pool::config::GlobalConfig, arg1: &mut Gauge<T0, T1, T2>, arg2: &mut clmm_pool::pool::Pool<T0, T1>, arg3: clmm_pool::position::Position, arg4: &sui::clock::Clock, arg5: &mut sui::tx_context::TxContext) {
    ...
    public fun earned_by_position<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &clmm_pool::pool::Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock) : u64 {
        assert!(check_gauger_pool<T0, T1, T2>(arg0, arg1), 9223372693985230856);
        assert!(sui::object_table::contains<sui::object::ID, clmm_pool::position::Position>(&arg0.staked_positions, arg2), 9223372698279936004);
    ...
    fun earned_internal<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &clmm_pool::pool::Pool<T0, T1>, arg2: sui::object::ID, arg3: u64) : u64 {
        ...
        let v8 = sui::object_table::borrow<sui::object::ID, clmm_pool::position::Position>(&arg0.staked_positions, arg2);
        let (v9, v10) = clmm_pool::position::tick_range(v8);
        integer_mate::full_math_u128::mul_div_floor(clmm_pool::pool::get_magma_distribution_growth_inside<T0, T1>(arg1, v9, v10, v2) - sui::table::borrow<sui::object::ID, RewardProfile>(&arg0.rewards, arg2).growth_inside, clmm_pool::position::liquidity(v8), 18446744073709551616) as u64
    }
    
    public fun get_position_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) {
        assert!(check_gauger_pool<T0, T1, T2>(arg0, arg1), 9223373428424638472);
        assert!(sui::object_table::contains<sui::object::ID, clmm_pool::position::Position>(&arg0.staked_positions, arg2), 9223373432719343620);
        get_reward_internal<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4);
    }
    
    public fun get_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>, arg2: &sui::clock::Clock, arg3: &mut sui::tx_context::TxContext) {
    ...
    public fun get_reward_for<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>, arg2: address, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) {
    ...
    fun get_reward_internal<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) {
        let (v0, v1) = clmm_pool::position::tick_range(sui::object_table::borrow<sui::object::ID, clmm_pool::position::Position>(&arg0.staked_positions, arg2));
    ...
    public fun notify_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &distribution::voter_cap::VoterCap, arg2: &mut clmm_pool::pool::Pool<T0, T1>, arg3: sui::balance::Balance<T2>, arg4: &sui::clock::Clock, arg5: &mut sui::tx_context::TxContext) : (sui::balance::Balance<T0>, sui::balance::Balance<T1>) {
    ...
    fun notify_reward_amount_internal<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>, arg2: u64, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) {
        ...
        if (v0 >= arg0.period_finish) {
            ...
            clmm_pool::pool::sync_magma_distribution_reward<T0, T1>(arg1, std::option::borrow<gauge_cap::gauge_cap::GaugeCap>(&arg0.gauge_cap), arg0.reward_rate, sui::balance::value<T2>(&arg0.reserves_balance), v2);
        } else {
            ...
            clmm_pool::pool::sync_magma_distribution_reward<T0, T1>(arg1, std::option::borrow<gauge_cap::gauge_cap::GaugeCap>(&arg0.gauge_cap), arg0.reward_rate, sui::balance::value<T2>(&arg0.reserves_balance) + ((v4 / 18446744073709551616) as u64), v2);
        };
        sui::table::add<u64, u128>(&mut arg0.reward_rate_by_epoch, clmm_pool::config::epoch_start(v0), arg0.reward_rate);
        assert!(arg0.reward_rate != 0, 9223373952411435028);
        assert!(arg0.reward_rate <= integer_mate::full_math_u128::mul_div_floor(sui::balance::value<T2>(&arg0.reserves_balance) as u128, 18446744073709551616, v1 as u128), 9223373956706533398);
    ...
    public fun notify_reward_without_claim<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &distribution::voter_cap::VoterCap, arg2: &mut clmm_pool::pool::Pool<T0, T1>, arg3: sui::balance::Balance<T2>, arg4: &sui::clock::Clock, arg5: &mut sui::tx_context::TxContext) {
        check_voter_cap<T0, T1, T2>(arg0, arg1);
        let v0 = sui::balance::value<T2>(&arg3);
    ...
    public fun withdraw_position<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut clmm_pool::pool::Pool<T0, T1>, arg2: sui::object::ID, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) {
        assert!(sui::object_table::contains<sui::object::ID, clmm_pool::position::Position>(&arg0.staked_positions, arg2) && sui::table::contains<sui::object::ID, PositionStakeInfo>(&arg0.staked_position_infos, arg2), 9223373570158297092);
        ...
        if (v0.from != sui::tx_context::sender(arg4)) {
            ...
            let v1 = sui::object_table::remove<sui::object::ID, clmm_pool::position::Position>(&mut arg0.staked_positions, arg2);
            let v2 = clmm_pool::position::liquidity(&v1);
            if (v2 > 0) {
                let (v3, v4) = clmm_pool::position::tick_range(&v1);
                clmm_pool::pool::unstake_from_magma_distribution<T0, T1>(arg1, std::option::borrow<gauge_cap::gauge_cap::GaugeCap>(&arg0.gauge_cap), v2, v3, v4, arg3);
            };
            clmm_pool::pool::mark_position_unstaked<T0, T1>(arg1, std::option::borrow<gauge_cap::gauge_cap::GaugeCap>(&arg0.gauge_cap), arg2);
