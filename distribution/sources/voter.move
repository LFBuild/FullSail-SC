        ...
        while (v4 < v5) {
            ...
            let v10 = if (0x2::table::contains<LockID, 0x2::table::Table<PoolID, u64>>(&arg0.votes, v0)) {
                if (0x2::table::contains<PoolID, u64>(0x2::table::borrow<LockID, 0x2::table::Table<PoolID, u64>>(&arg0.votes, v0), v7)) {
                    let v11 = 0;
                    0x2::table::borrow<PoolID, u64>(0x2::table::borrow<LockID, 0x2::table::Table<PoolID, u64>>(&arg0.votes, v0), v7) != &v11
                } else {
                    false
                }
            } else {
            ...
            0x2::table::add<GaugeID, u64>(&mut arg0.weights, v8, v12 + v9);
            ...
            let v13 = 0x2::table::borrow_mut<LockID, 0x2::table::Table<PoolID, u64>>(&mut arg0.votes, v0);
            let v14 = if (0x2::table::contains<PoolID, u64>(v13, v7)) {
                0x2::table::remove<PoolID, u64>(v13, v7)
            } else {
                0
            };
            ...
            let v15 = EventVoted{
                ...
                lock          : v0.id, 
                voting_weight : v9, 
                pool_weight   : *0x2::table::borrow<GaugeID, u64>(&arg0.weights, v8),
            };
