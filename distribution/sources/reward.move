module distribution::reward {
    ...
    public(friend) fun earned<T0>(arg0: &Reward, arg1: sui::object::ID, arg2: &sui::clock::Clock) : u64 {
        ...
        let v5 = sui::table::borrow<u64, Checkpoint>(sui::table::borrow<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), get_prior_balance_index(arg0, arg1, v4));
        ...
        if (v8 > 0) {
            ...
            while (v9 < v8) {
                ...
                if (!sui::table::contains<std::type_name::TypeName, sui::table::Table<u64, u64>>(&arg0.token_rewards_per_epoch, v2)) {
                    break
                };
                let v15 = sui::table::borrow<std::type_name::TypeName, sui::table::Table<u64, u64>>(&arg0.token_rewards_per_epoch, v2);
    ...
    public fun get_prior_balance_index(arg0: &Reward, arg1: sui::object::ID, arg2: u64) : u64 {
        ...
        if (sui::table::borrow<u64, Checkpoint>(sui::table::borrow<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), v0 - 1).timestamp <= arg2) {
            return v0 - 1
        };
    ...
    public(friend) fun get_reward_internal<T0>(arg0: &mut Reward, arg1: address, arg2: sui::object::ID, arg3: &sui::clock::Clock, arg4: &mut sui::tx_context::TxContext) : std::option::Option<sui::balance::Balance<T0>> {
        ...
        if (!sui::table::contains<std::type_name::TypeName, sui::table::Table<sui::object::ID, u64>>(&arg0.last_earn, v1)) {
            sui::table::add<std::type_name::TypeName, sui::table::Table<sui::object::ID, u64>>(&mut arg0.last_earn, v1, sui::table::new<sui::object::ID, u64>(arg4));
        };
        let v2 = sui::table::borrow_mut<std::type_name::TypeName, sui::table::Table<sui::object::ID, u64>>(&mut arg0.last_earn, v1);
        ...
        if (v0 > 0) {
            return std::option::some<sui::balance::Balance<T0>>(sui::balance::split<T0>(sui::bag::borrow_mut<std::type_name::TypeName, sui::balance::Balance<T0>>(&mut arg0.balances, v1), v0))
        };
    ...
    public(friend) fun notify_reward_amount_internal<T0>(arg0: &mut Reward, arg1: sui::balance::Balance<T0>, arg2: &sui::clock::Clock, arg3: &mut sui::tx_context::TxContext) {
        ...
        if (!sui::table::contains<std::type_name::TypeName, sui::table::Table<u64, u64>>(&arg0.token_rewards_per_epoch, v1)) {
            sui::table::add<std::type_name::TypeName, sui::table::Table<u64, u64>>(&mut arg0.token_rewards_per_epoch, v1, sui::table::new<u64, u64>(arg3));
        };
        let v3 = sui::table::borrow_mut<std::type_name::TypeName, sui::table::Table<u64, u64>>(&mut arg0.token_rewards_per_epoch, v1);
        ...
        if (!sui::bag::contains<std::type_name::TypeName>(&arg0.balances, v1)) {
            ...
            sui::balance::join<T0>(sui::bag::borrow_mut<std::type_name::TypeName, sui::balance::Balance<T0>>(&mut arg0.balances, v1), arg1);
        };
    ...
    fun write_checkpoint_internal(arg0: &mut Reward, arg1: sui::object::ID, arg2: u64, arg3: u64, arg4: &mut sui::tx_context::TxContext) {
        let v0 = if (sui::table::contains<sui::object::ID, u64>(&arg0.num_checkpoints, arg1)) {
            *sui::table::borrow<sui::object::ID, u64>(&arg0.num_checkpoints, arg1)
        } else {
            0
        };
        if (v0 > 0 && distribution::common::epoch_start(sui::table::borrow<u64, Checkpoint>(sui::table::borrow<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), v0 - 1).timestamp) == distribution::common::epoch_start(arg3)) {
            let v1 = sui::table::borrow_mut<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&mut arg0.checkpoints, arg1);
            ...
            if (!sui::table::contains<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1)) {
                sui::table::add<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&mut arg0.checkpoints, arg1, sui::table::new<u64, Checkpoint>(arg4));
            };
            let v3 = sui::table::borrow_mut<sui::object::ID, sui::table::Table<u64, Checkpoint>>(&mut arg0.checkpoints, arg1);
    ...
    fun write_supply_checkpoint_internal(arg0: &mut Reward, arg1: u64) {
        let v0 = arg0.supply_num_checkpoints;
        if (v0 > 0 && distribution::common::epoch_start(sui::table::borrow<u64, SupplyCheckpoint>(&arg0.supply_checkpoints, v0 - 1).timestamp) == distribution::common::epoch_start(arg1)) {
