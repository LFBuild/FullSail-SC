module integrate::pool_script_v3 {
    public entry fun collect_fee<T0, T1>(
        ...
        arg3: &mut sui::coin::Coin<T0>,
        arg4: &mut sui::coin::Coin<T1>,
    ...
    public entry fun collect_reward<T0, T1, T2>(
        ...
        sui::coin::join<T2>(
            ...
            sui::coin::from_balance<T2>(
                clmm_pool::pool::collect_reward<T0, T1, T2>(arg0, arg1, arg2, arg3, true, arg5),
                arg6
            )
        );
    }
    ...
    public entry fun update_rewarder_emission<T0, T1, T2>(
        ...
        clmm_pool::pool::update_emission<T0, T1, T2>(
            arg0,
            arg1,
            arg2,
            integer_mate::full_math_u128::mul_div_floor((arg3 as u128), 18446744073709551616, (arg4 as u128)),
            arg5,
            arg6
        );
    }
