module integrate::fetcher_script {
    ...
    public entry fun fetch_positions<T0, T1>(
    ...
    public entry fun fetch_position_fees<T0, T1>(
    ...
    public entry fun fetch_position_magma_distribution<T0, T1>(
        arg0: &clmm_pool::config::GlobalConfig,
        arg1: &mut clmm_pool::pool::Pool<T0, T1>,
        arg2: sui::object::ID,
    ...
    public entry fun fetch_position_points<T0, T1>(
        arg0: &clmm_pool::config::GlobalConfig,
        arg1: &mut clmm_pool::pool::Pool<T0, T1>,
        arg2: sui::object::ID,
    ...
    public entry fun fetch_position_rewards<T0, T1>(
        arg0: &clmm_pool::config::GlobalConfig,
        arg1: &mut clmm_pool::pool::Pool<T0, T1>,
        arg2: sui::object::ID,
        arg3: &sui::clock::Clock
