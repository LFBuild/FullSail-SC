module integrate::fetcher_script {
    ...
    public entry fun fetch_position_magma_distribution<CoinTypeA, CoinTypeB>(
        ...
        let fetch_position_distribution_event = FetchPositionMagmaDistributionEvent {
            position_id,
            distribution,
        };
        sui::event::emit<FetchPositionMagmaDistributionEvent>(fetch_position_distribution_event);
    }
