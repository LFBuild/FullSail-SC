...
export TOTAL_REWARD_AMOUNT5=6000000000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS5=1206000 # set the distribution period in seconds
