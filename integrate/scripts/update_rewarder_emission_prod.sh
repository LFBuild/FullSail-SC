...
export TOTAL_REWARD_AMOUNT1=428571000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS1=345600 # set the distribution period in seconds
...
export TOTAL_REWARD_AMOUNT2=428571000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS2=345600 # set the distribution period in seconds
...
export TOTAL_REWARD_AMOUNT3=428571000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS3=345600 # set the distribution period in seconds
...
export TOTAL_REWARD_AMOUNT4=428571000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS4=345600 # set the distribution period in seconds
...
export TOTAL_REWARD_AMOUNT5=428571000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS5=345600 # set the distribution period in seconds
...
export TOTAL_REWARD_AMOUNT6=428571000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS6=345600 # set the distribution period in seconds
...
--move-call $PACKAGE::pool_script_v3::update_rewarder_emission "<$COIN_A_2,$COIN_B_2,$REWARD_TOKEN_TYPE>" @$GLOBAL_CONFIG @$POOL2 @$REWARDER_GLOBAL_VAULT $TOTAL_REWARD_AMOUNT2 $DISTRIBUTION_PERIOD_SECONDS2 @$CLOCK \
--move-call $PACKAGE::pool_script_v3::update_rewarder_emission "<$COIN_A_3,$COIN_B_3,$REWARD_TOKEN_TYPE>" @$GLOBAL_CONFIG @$POOL3 @$REWARDER_GLOBAL_VAULT $TOTAL_REWARD_AMOUNT3 $DISTRIBUTION_PERIOD_SECONDS3 @$CLOCK \
--move-call $PACKAGE::pool_script_v3::update_rewarder_emission "<$COIN_A_4,$COIN_B_4,$REWARD_TOKEN_TYPE>" @$GLOBAL_CONFIG @$POOL4 @$REWARDER_GLOBAL_VAULT $TOTAL_REWARD_AMOUNT4 $DISTRIBUTION_PERIOD_SECONDS4 @$CLOCK \
--move-call $PACKAGE::pool_script_v3::update_rewarder_emission "<$COIN_A_5,$COIN_B_5,$REWARD_TOKEN_TYPE>" @$GLOBAL_CONFIG @$POOL5 @$REWARDER_GLOBAL_VAULT $TOTAL_REWARD_AMOUNT5 $DISTRIBUTION_PERIOD_SECONDS5 @$CLOCK \
--move-call $PACKAGE::pool_script_v3::update_rewarder_emission "<$COIN_A_6,$COIN_B_6,$REWARD_TOKEN_TYPE>" @$GLOBAL_CONFIG @$POOL6 @$REWARDER_GLOBAL_VAULT $TOTAL_REWARD_AMOUNT6 $DISTRIBUTION_PERIOD_SECONDS6 @$CLOCK