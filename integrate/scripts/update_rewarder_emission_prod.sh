...
export TOTAL_REWARD_AMOUNT5=1106538000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS5=500400 # set the distribution period in seconds
