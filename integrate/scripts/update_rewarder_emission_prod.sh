...
export TOTAL_REWARD_AMOUNT5=1500000000000 # set the total reward amount for the pool
export DISTRIBUTION_PERIOD_SECONDS5=612000 # set the distribution period in seconds
