...
sui client ptb \
  ...
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[88,197,75,184,210,77,120,33,227,85,216,223,129,199,240,15,20,33,21,3,160,69,47,247,32,199,226,62,150,248,69,204] 1758533132776 @$CLOCK \
  --assign airdrop \
