...
sui client ptb \
  ...
  --split-coins @0xef1835311f0d615bf11b2aa2068231e724a8809080ad923393adfe867f929cf0 "[877313142644]" \
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[218,184,32,22,200,246,185,190,133,166,7,155,126,14,51,30,252,189,84,119,134,56,119,106,64,51,168,5,171,91,110,155] 1763242595673 @$CLOCK \
  --assign airdrop \
