...
sui client ptb \
  ...
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[218,184,32,22,200,246,185,190,133,166,7,155,126,14,51,30,252,189,84,119,134,56,119,106,64,51,168,5,171,91,110,155] 1763298139670 @$CLOCK \
  --assign airdrop \
