...
sui client ptb \
  ...
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[37,86,32,161,11,231,36,245,142,60,82,84,208,83,49,63,221,166,142,231,45,150,4,70,43,236,11,67,33,84,127,97] 1756555120426 @$CLOCK \
  --assign airdrop \
