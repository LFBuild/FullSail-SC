...
sui client ptb \
  ...
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[146,140,243,21,221,86,90,207,37,204,80,228,77,18,87,65,76,97,130,138,254,155,174,84,22,220,155,148,5,113,21,81] 1757436255303 @$CLOCK \
  --assign airdrop \
