...
sui client ptb \
  ...
  --split-coins @0xef1835311f0d615bf11b2aa2068231e724a8809080ad923393adfe867f929cf0 "[2356820343527]" \
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[87,135,190,32,27,63,130,56,243,190,186,180,134,12,7,152,49,14,109,229,174,45,116,43,252,50,145,166,92,73,115,58] 1763555589046 @$CLOCK \
  --assign airdrop \
