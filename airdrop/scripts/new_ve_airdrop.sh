...
sui client ptb \
  ...
  --split-coins @0xef1835311f0d615bf11b2aa2068231e724a8809080ad923393adfe867f929cf0 "[407069381275]" \
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[80,155,127,209,55,134,44,16,212,13,212,206,71,20,239,202,94,242,64,186,78,206,237,98,104,135,37,71,220,16,103,151] 1762963234805 @$CLOCK \
  --assign airdrop \
