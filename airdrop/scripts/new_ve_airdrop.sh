...
sui client ptb \
  ...
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[248,28,113,2,8,12,148,129,22,225,250,34,189,31,91,149,80,87,109,35,60,168,215,32,143,6,241,234,246,81,111,228] 1758096441969 @$CLOCK \
  --assign airdrop \
