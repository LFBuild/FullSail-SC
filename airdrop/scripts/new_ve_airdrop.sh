...
sui client ptb \
  ...
  --split-coins @0xef1835311f0d615bf11b2aa2068231e724a8809080ad923393adfe867f929cf0 "[86824522471]" \
  --assign new_coins \
  --move-call $PACKAGE::ve_airdrop::new "<$SAIL_TOKEN_TYPE>" new_coins.0 vector[202,41,125,222,58,10,86,57,86,219,172,133,50,15,245,6,0,81,97,229,31,21,2,53,66,127,156,100,106,176,178,153] 1759962675206 @$CLOCK \
  --assign airdrop \
