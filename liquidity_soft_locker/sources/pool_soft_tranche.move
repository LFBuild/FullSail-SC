...
module liquidity_soft_locker::pool_soft_tranche {
    ...
    /// * `whitelisted_tokens` - Table of whitelisted token types that are allowed to be used as rewards in the tranches
    ...
    public fun is_token_whitelisted(manager: &PoolSoftTrancheManager, token_type: TypeName): bool {
