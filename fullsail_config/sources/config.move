module fullsail_config::config {
    ...
    public entry fun add_role(_arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
    ...
    public entry fun remove_member(_arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
    ...
    public entry fun remove_role(_arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
    ...
    public entry fun set_roles(_arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
    ...
    fun init(arg0: &mut sui::tx_context::TxContext) {
        ...
        let admin_cap_id = sui::object::id<AdminCap>(&v1);
        sui::transfer::transfer<AdminCap>(v1, v3);
        let global_config_id = sui::object::id<GlobalConfig>(&v2);
