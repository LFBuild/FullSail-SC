module fullsail_config::launchpad_pool {
    ...
    public entry fun add_extension_to_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: std::string::String,
        arg4: std::string::String,
        arg5: &sui::tx_context::TxContext
    ) {
    ...
    public entry fun add_launchpad_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: bool,
        ...
        arg8: vector<std::string::String>,
        arg9: std::string::String,
        arg10: std::string::String,
        arg11: std::string::String,
        arg12: std::string::String,
        arg13: std::string::String,
        arg14: std::string::String,
        arg15: std::string::String,
        arg16: &sui::tx_context::TxContext
    ) {
        fullsail_config::config::checked_package_version(arg0);
    ...
    public fun close_launchpad_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: &sui::tx_context::TxContext
    ) {
        fullsail_config::config::checked_package_version(arg0);
    ...
    public fun open_launchpad_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: &sui::tx_context::TxContext
    ...
    public entry fun remove_extension_from_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: std::string::String,
        arg4: &sui::tx_context::TxContext
    ) {
        fullsail_config::config::checked_package_version(arg0);
    ...
    public fun remove_launchpad_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: &sui::tx_context::TxContext
    ...
    public fun remove_media_from_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: std::string::String,
    ...
    public entry fun update_extension_from_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut LaunchpadPools,
        arg2: address,
        arg3: std::string::String,
