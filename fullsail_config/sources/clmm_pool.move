module fullsail_config::clmm_pool {
    ...
    public entry fun add_clmm_pool(
        ...
        arg8: bool,
        arg9: bool,
        arg10: &sui::tx_context::TxContext
    ) {
    ...
    public entry fun close_clmm_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut ClmmPools,
        arg2: address,
    ...
    public entry fun open_clmm_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut ClmmPools,
        arg2: address,
        arg3: &sui::tx_context::TxContext
    ...
    public entry fun remove_clmm_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut ClmmPools,
        arg2: address,
        arg3: &sui::tx_context::TxContext
    ...
    public entry fun update_clmm_pool(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut ClmmPools,
        arg2: address,
        arg3: std::string::String,
    ...
    public entry fun update_pool_type(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut ClmmPools,
        arg2: address,
        arg3: std::string::String,
    ...
    public entry fun update_rewarder_display(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut ClmmPools,
        arg2: address,
        arg3: u64,
