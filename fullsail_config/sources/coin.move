module fullsail_config::coin {
    ...
    public entry fun add_extension_to_coin<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: std::string::String,
    ...
    public entry fun remove_coin<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: &sui::tx_context::TxContext
    ) {
        fullsail_config::config::checked_package_version(arg0);
    ...
    public entry fun remove_extension_from_coin<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
    ...
    public entry fun update_coin<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: std::string::String,
    ...
    public entry fun update_coin_name<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: &sui::tx_context::TxContext
    ...
    public entry fun update_coin_symbol<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: &sui::tx_context::TxContext
    ...
    public entry fun update_coingecko_id<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: &sui::tx_context::TxContext
    ...
    public entry fun update_extension_from_coin<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: std::string::String,
    ...
    public entry fun update_pyth_id<T0>(
        arg0: &fullsail_config::config::GlobalConfig,
        arg1: &mut CoinList,
        arg2: std::string::String,
        arg3: &sui::tx_context::TxContext
