module fullsail_config::coin {
    struct CoinList has store, key {
        id: 0x2::object::UID,
        coins: 0x2::table::Table<std::type_name::TypeName, Coin>,
    }
    ...
    public entry fun add_coin<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: std::string::String, arg4: std::string::String, arg5: std::string::String, arg6: u8, arg7: std::string::String, arg8: std::string::String, arg9: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 0);
        let v1 = Coin{
            name             : arg2, 
            symbol           : arg3, 
            coingecko_id     : arg4, 
        ...
        0x2::table::add<std::type_name::TypeName, Coin>(&mut arg1.coins, v0, v1);
        let v2 = AddCoinEvent{coin_type: std::string::from_ascii(std::type_name::into_string(v0))};
        0x2::event::emit<AddCoinEvent>(v2);
    }
    
    public entry fun add_extension_to_coin<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: std::string::String, arg4: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
        fullsail_config::config::checked_has_add_role(arg0, 0x2::tx_context::sender(arg4));
        let v0 = std::type_name::get<T0>();
        assert!(0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 1);
        let v1 = 0x2::table::borrow_mut<std::type_name::TypeName, Coin>(&mut arg1.coins, v0);
        assert!(!0x2::vec_map::contains<std::string::String, std::string::String>(&v1.extension_fields, &arg2), 3);
        0x2::vec_map::insert<std::string::String, std::string::String>(&mut v1.extension_fields, arg2, arg3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = CoinList{
            ...
            coins : 0x2::table::new<std::type_name::TypeName, Coin>(arg0),
        };
    ...
    public entry fun remove_coin<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: &0x2::tx_context::TxContext) {
        ...
        let v0 = std::type_name::get<T0>();
        assert!(0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 1);
        0x2::table::remove<std::type_name::TypeName, Coin>(&mut arg1.coins, v0);
        let v1 = RemoveCoinEvent{coin_type: std::string::from_ascii(std::type_name::into_string(v0))};
        0x2::event::emit<RemoveCoinEvent>(v1);
    }
    
    public entry fun remove_extension_from_coin<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
        fullsail_config::config::checked_has_delete_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = std::type_name::get<T0>();
        assert!(0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 1);
        let v1 = 0x2::table::borrow_mut<std::type_name::TypeName, Coin>(&mut arg1.coins, v0);
        assert!(0x2::vec_map::contains<std::string::String, std::string::String>(&v1.extension_fields, &arg2), 2);
        let (_, _) = 0x2::vec_map::remove<std::string::String, std::string::String>(&mut v1.extension_fields, &arg2);
    ...
    public entry fun update_coin<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: std::string::String, arg4: std::string::String, arg5: std::string::String, arg6: u8, arg7: std::string::String, arg8: std::string::String, arg9: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
    ...
    public entry fun update_coin_name<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
    ...
    public entry fun update_coin_symbol<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
        fullsail_config::config::checked_has_update_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = std::type_name::get<T0>();
        assert!(0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 1);
    ...
    public entry fun update_coingecko_id<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
        fullsail_config::config::checked_has_update_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = std::type_name::get<T0>();
        assert!(0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 1);
    ...
    public entry fun update_extension_from_coin<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: std::string::String, arg4: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
        ...
        let v1 = 0x2::table::borrow_mut<std::type_name::TypeName, Coin>(&mut arg1.coins, v0);
        assert!(0x2::vec_map::contains<std::string::String, std::string::String>(&v1.extension_fields, &arg2), 2);
        let v2 = 0x2::vec_map::get_mut<std::string::String, std::string::String>(&mut v1.extension_fields, &arg2);
        *v2 = arg3;
    ...
    public entry fun update_pyth_id<T0>(arg0: &fullsail_config::config::GlobalConfig, arg1: &mut CoinList, arg2: std::string::String, arg3: &0x2::tx_context::TxContext) {
        fullsail_config::config::checked_package_version(arg0);
        fullsail_config::config::checked_has_update_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = std::type_name::get<T0>();
        assert!(0x2::table::contains<std::type_name::TypeName, Coin>(&arg1.coins, v0), 1);
