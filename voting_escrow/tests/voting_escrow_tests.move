// module voting_escrow::voting_escrow_tests;
...
// //         let new_owner = voting_escrow::owner_of(&ve, lock_a_id, scenario.ctx());
...
//     {
//         let mut ve = scenario.take_shared<VotingEscrow<SAIL>>();
//         let cap = scenario.take_from_sender<VotingEscrowCap>();
