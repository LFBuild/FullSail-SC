...
module voting_escrow::voting_escrow {
    ...
    public struct VotingEscrow<phantom SailCoinType> has store, key {
        ...
        voting_dao: voting_escrow::voting_dao::VotingDAO,
        ...
        managed_to_locked: sui::table::Table<ID, voting_escrow::locked_managed_reward::LockedManagedReward>,
        managed_to_free: sui::table::Table<ID, voting_escrow::free_managed_reward::FreeManagedReward>,
    ...
    public fun split<SailCoinType>(
        ...
        assert!(
            locked_balance.end > voting_escrow::common::current_timestamp(clock) || locked_balance.is_permanent,
            ESplitAmountZero
        );
    ...
    public fun create<SailCoinType>(
        ...
        let mut voting_escrow = VotingEscrow<SailCoinType> {
            ...
            voting_dao: voting_escrow::voting_dao::create(ctx),
            ...
            managed_to_locked: sui::table::new<ID, voting_escrow::locked_managed_reward::LockedManagedReward>(
                ctx
            ),
            managed_to_free: sui::table::new<ID, voting_escrow::free_managed_reward::FreeManagedReward>(
                ctx
            ),
        ...
        let global_point = GlobalPoint {
            ...
            ts: voting_escrow::common::current_timestamp(clock),
            permanent_lock_balance: 0,
        };
        voting_escrow.point_history.add(0, global_point);
        let voting_escrow_cap = voting_escrow::voting_escrow_cap::create(inner_id, ctx);
    ...
    public fun withdraw<SailCoinType>(
        ...
        assert!(voting_escrow::common::current_timestamp(clock) >= locked_balance.end, EWithdrawBeforeEndTime);
    ...
    fun checkpoint_internal<SailCoinType>(
            ...
            if (old_locked_balance.end > current_timestamp && old_locked_balance.amount > 0) {
                old_user_point.slope = integer_mate::i128::from(
                    integer_mate::full_math_u128::mul_div_floor(
                        ...
                        1 << 64,
                        (voting_escrow::common::max_lock_time() as u128)
                    )
                );
        ...
        let mut period_timestamp = voting_escrow::common::to_period(last_point_timestamp);
        let mut i = 0;
        while (i < 255) {
            let next_epoch_timestamp = period_timestamp + voting_escrow::common::epoch();
    ...
    public fun create_lock_advanced<SailCoinType>(
        ...
        let end_time = if (permanent || perpetual) {
            ...
            voting_escrow::common::to_period(current_time + lock_duration_days * voting_escrow::common::day())
        };
        ...
        transfer::public_transfer<Lock>(lock, sender);
    }
    ...
    public fun create_lock_for<SailCoinType>(
        ...
        let start_time = voting_escrow::common::current_timestamp(clock);
        let end_time = if (permanent || perpetual) {
            0
        } else {
            voting_escrow::common::to_period(start_time + duration_days * voting_escrow::common::day())
        };
        let (lock_immut, create_lock_receipt) = voting_escrow.create_lock_internal(
            owner,
            lock_amount,
        ...
        transfer::public_transfer<Lock>(lock, owner);
    }
    ...
    public fun create_lock_migration<SailCoinType>(
        ...
        let lock_amount = coin.value();
        assert!(lock_amount > 0, ECreateLockForAmountZero);
        let (mut lock, create_lock_receipt) = voting_escrow.create_lock_internal(
    ...
    public fun create_managed_lock_for<SailCoinType>(
        ...
        let lock_managed_reward = voting_escrow::locked_managed_reward::create(
            voting_escrow.voter,
            object::id<VotingEscrow<SailCoinType>>(voting_escrow),
            sail_coin_type,
            ctx
        );
        let free_managed_reward = voting_escrow::free_managed_reward::create(
            voting_escrow.voter,
            object::id<VotingEscrow<SailCoinType>>(voting_escrow),
            sail_coin_type,
            ctx
        ...
        let create_managed_event = EventCreateManaged {
            ...
            lock_id,
            sender,
            locked_managed_reward: object::id<voting_escrow::locked_managed_reward::LockedManagedReward>(
                &lock_managed_reward
            ),
            free_managed_reward: object::id<voting_escrow::free_managed_reward::FreeManagedReward>(&free_managed_reward),
        };
    ...
    fun delegate_internal<SailCoinType>(
        ...
        assert!(
            delegatee == object::id_from_address(@0x0) || voting_escrow.locked.contains(delegatee),
        ...
        assert!(
            clock.timestamp_ms() - *voting_escrow.ownership_change_at.borrow(
                lock_id
            ) >= voting_escrow::common::get_time_to_finality_ms(),
    ...
    public fun deposit_managed<SailCoinType>(
        ...
        assert!(
            voting_escrow.balance_of_nft_at_internal(lock_id, voting_escrow::common::current_timestamp(clock)) > 0,
        ...
        let deposit_managed_event = EventDepositManaged {
            owner: voting_escrow.owner_of(lock_id, ctx),
            lock_id,
            managed_lock_id,
    ...
    public fun free_managed_reward_notify_reward<SailCoinType, RewardCoinType>(
        voting_escrow: &mut VotingEscrow<SailCoinType>,
        whitelisted_token: Option<voting_escrow::whitelisted_tokens::WhitelistedToken>,
    ...
    public fun get_voting_power<SailCoinType>(
        ...
        voting_escrow.balance_of_nft_at_internal(lock_id, voting_escrow::common::current_timestamp(clock))
    }
    ...
    fun increase_amount_for_internal<SailCoinType>(
        ...
        assert!(
            current_locked_balance.end > voting_escrow::common::current_timestamp(
                clock
            ) || current_locked_balance.is_permanent,
    ...
    public fun increase_unlock_time<SailCoinType>(
        ...
        let current_time = voting_escrow::common::current_timestamp(clock);
        let lock_end_epoch_time = voting_escrow::common::to_period(
            current_time + new_lock_duration_days * voting_escrow::common::day()
        );
        ...
        assert!(
            lock_end_epoch_time <= current_time + (voting_escrow::common::max_lock_time() as u64),
    ...
    public fun lock_permanent<SailCoinType>(
        ...
        assert!(v3.end > voting_escrow::common::current_timestamp(clock), ELockPermanentExpired);
    ...
    public fun managed_to_free<SailCoinType>(voting_escrow: &VotingEscrow<SailCoinType>, lock_id: ID): ID {
        object::id<voting_escrow::free_managed_reward::FreeManagedReward>(
    ...
    public fun merge<SailCoinType>(
        ...
        assert!(
            lock_b_balance.end > voting_escrow::common::current_timestamp(clock) || lock_b_balance.is_permanent == true,
    ...
    public fun owner_of<SailCoinType>(voting_escrow: &VotingEscrow<SailCoinType>, lock_id: ID, ctx: &mut TxContext): address {
        if (voting_escrow.owner_of.contains(lock_id)) {
    ...
    public fun create_team_cap<SailCoinType>(voting_escrow: &VotingEscrow<SailCoinType>, publisher: &sui::package::Publisher, ctx: &mut TxContext): voting_escrow::team_cap::TeamCap {
        voting_escrow.checked_package_version();
        assert!(publisher.from_module<VOTING_ESCROW>(), EGrantTeamCapInvalidPublisher);
        let team_cap = voting_escrow::team_cap::create(object::id(voting_escrow), ctx);
    ...
    public fun toggle_split<SailCoinType>(
        voting_escrow: &mut VotingEscrow<SailCoinType>,
        team_cap: &voting_escrow::team_cap::TeamCap,
        who: address,
        allowed: bool
    ) {
        voting_escrow.checked_package_version();
    ...
    fun total_supply_at_internal<SailCoinType>(voting_escrow: &VotingEscrow<SailCoinType>, epoch: u64, time: u64): u64 {
        ...
        let mut point_epoch_time = voting_escrow::common::to_period(last_point_ts);
        let mut i = 0;
        while (i < 255) {
            let next_epoch_time = point_epoch_time + voting_escrow::common::epoch();
    ...
    public fun unlock_permanent<SailCoinType>(
        ...
        old_locked_balance.end = voting_escrow::common::to_period(current_time + voting_escrow::common::max_lock_time());
    ...
    fun validate_lock_duration<SailCoinType>(
        ...
        assert!(
            ...
            || is_perpetual
                || (
                    duration_days * voting_escrow::common::day() >= voting_escrow::common::min_lock_time()
                        && duration_days * voting_escrow::common::day() <= voting_escrow::common::max_lock_time()
                ),
    ...
    public fun withdraw_managed<SailCoinType>(
        ...
        let lock_end_time = voting_escrow::common::to_period(
            voting_escrow::common::current_timestamp(clock) + voting_escrow::common::max_lock_time()
        );
        voting_escrow.managed_to_free.borrow_mut(managed_lock_id).get_reward<SailCoinType>(tx_context::sender(ctx), lock_id, clock, ctx);
    ...
    public fun create_voting_escrow_cap(
        publisher: &sui::package::Publisher,
        voting_escrow_id: ID,
        ctx: &mut TxContext
    ): VotingEscrowCap {
        ...
        let voting_escrow_cap = voting_escrow::voting_escrow_cap::create(voting_escrow_id, ctx);
